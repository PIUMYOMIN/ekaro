    ...
    () => {
      ...
      const fetchTopSellers = async () => {
        try {
          ...
          // Simplified transformation since API now returns full URLs
          const transformed = sellersData.map(seller => ({
            ...
            verified: seller.status === "approved" || seller.status === "active",
            originalData: seller // Pass the full API data
          }));
