  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore product categories on Pyonea. Find electronics, fashion, home goods and more from trusted Myanmar sellers."
        />
        <link rel="canonical" href="https://pyonea.com/categories" />
        <meta property="og:title" content="Browse Categories | Pyonea" />
        <meta property="og:description" content="Discover thousands of products across various categories on Pyonea marketplace." />
        <meta property="og:url" content="https://pyonea.com/categories" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${selectedFilter === "with-products"
              ...
              >
                ...
                <span className={`text-xs px-1.5 py-0.5 rounded-full ${selectedFilter === "with-products"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${selectedFilter === "popular"
                  ? "bg-green-600 text-white shadow-sm"
                  : "bg-white text-gray-700 hover:bg-gray-100 border border-gray-200"
                  }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${selectedFilter === "featured"
                  ? "bg-green-600 text-white shadow-sm"
                  : "bg-white text-gray-700 hover:bg-gray-100 border border-gray-200"
                  }`}
              >
                ...
                <span className={`text-xs px-1.5 py-0.5 rounded-full ${selectedFilter === "featured"
                  ? 'bg-white/20 text-white'
                  : 'bg-gray-100 text-gray-600'
                  }`}>
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className={`block bg-white rounded-xl shadow-sm border overflow-hidden group ${hasProducts
                      ...
                      >
                        ...
                        <div className="p-6 border-b border-gray-100">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <h3 className={`text-lg font-semibold line-clamp-1 ${hasProducts
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <ShoppingBagIcon className={`h-4 w-4 ${hasProducts ? 'text-gray-400' : 'text-gray-300'
                                  }`} />
                                <span className={`text-sm ${hasProducts ? 'text-gray-600' : 'text-gray-400'
                                  }`}>
