    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          <KPI title="Total Commission"    value={fmtMMK(data.commission_revenue ?? data.total_commission ?? 0)} subtitle="From all delivered orders" icon={CurrencyDollarIcon} iconColor="text-emerald-700" bg="bg-emerald-50" isString />
